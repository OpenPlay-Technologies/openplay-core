...
# Upgrade OpenPlay Core Package
# This script upgrades the openplay_core package using the original upgrade capability
...
if [ -z "$ORIGINAL_OPENPLAY_CORE_PACKAGE_ID" ] || [ "$ORIGINAL_OPENPLAY_CORE_PACKAGE_ID" = "null" ]; then
...
ORIGINAL_UPGRADE_CAP="$OPENPLAY_CORE_UPGRADE_CAP"
ORIGINAL_PACKAGE_ID="$ORIGINAL_OPENPLAY_CORE_PACKAGE_ID"
PREVIOUS_PACKAGE_ID="${CURRENT_OPENPLAY_CORE_PACKAGE_ID:-$ORIGINAL_OPENPLAY_CORE_PACKAGE_ID}"
ORIGINAL_REGISTRY_ID="$OPENPLAY_CORE_REGISTRY_ID"
ORIGINAL_ADMIN_CAP="$OPENPLAY_CORE_ADMIN_CAP"

# Get next version number
NEXT_VERSION=$(get_next_version "$ACTIVE_ENV")
print_status "Upgrading to version $NEXT_VERSION"

print_status "Upgrading OpenPlay Core package..."
...
OPENPLAY_CORE_VERSION="$NEXT_VERSION"
CURRENT_OPENPLAY_CORE_PACKAGE_ID="$NEW_PACKAGE_ID"
# Keep original values unchanged
ORIGINAL_OPENPLAY_CORE_PACKAGE_ID="$ORIGINAL_PACKAGE_ID"
OPENPLAY_CORE_REGISTRY_ID="$ORIGINAL_REGISTRY_ID"
OPENPLAY_CORE_ADMIN_CAP="$ORIGINAL_ADMIN_CAP"
OPENPLAY_CORE_UPGRADE_CAP="$ORIGINAL_UPGRADE_CAP"
...
save_upgrade_output "$ACTIVE_ENV" "$TIMESTAMP" "$OPENPLAY_CORE_VERSION"

# Print summary
echo ""
print_success "OpenPlay Core upgrade completed successfully!"
echo ""
print_status "Upgrade Summary:"
echo "  Version: $OPENPLAY_CORE_VERSION"
echo "  Previous Package ID: $PREVIOUS_PACKAGE_ID"
echo "  New Package ID: $CURRENT_OPENPLAY_CORE_PACKAGE_ID"
